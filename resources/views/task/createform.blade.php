    ...
    <div class="container mt-2 mb-2">
        ...
        <form action="/{{ auth()->user()->current_team_id }}/tasks/store" method="POST">
            ...
            <div class="form-group">
                ...
                <textarea class="form-control" id="task_description" name="task_description" value="{{ old('task_description') }}"
                    rows="3"></textarea>
            ...
            <div class="form-group">
                ...
                @forelse($tasks as $task)
                    <div class="form-check">
                        <input class="form-check-input" type="checkbox" name="task_dependencies[]"
