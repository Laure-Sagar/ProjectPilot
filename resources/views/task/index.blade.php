<x-app-layout>
    ...
    <div class="container mx-auto py-8">
        ...
        <a href="/task_form" class="bg-dark-500 hover:bg-blue-700 text-dark font-bold py-2 px-4 rounded-md">Add Task</a>
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
            ...
            <div class="bg-white rounded-lg shadow-md p-4">
                <div class="flex justify-between items-center mb-4">
                    <span class="text-sm text-gray-600">Duration: <span class="font-bold">{{$task->task_duration}} days</span></span>
                </div>
                <div class="mb-4">
