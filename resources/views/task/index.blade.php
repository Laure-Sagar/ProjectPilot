                                ...
                                <a href="/{{ $task->id }}/subtasks">
                                    ...
                                    <div class="bg-white rounded-lg shadow-md py-4 px-4">
                                        <div class="flex justify-between items-center mb-4">
                                            ...
                                            <div
                                                class="loat-right bg-indigo-600 text-white hover:bg-indigo-500 focus:outline-none focus:bg-indigo-500 font-bold py-2 px-4 rounded-md">
                                                <a
                                        ...
                                        <div class="flex justify-between items-center mb-4">
                                            <span class="text-sm text-gray-600"><i>Duration:</i> <span
                                                    class="font-bold">{{ $task->duration }} days</span></span>
                                            <div
                                                class="loat-right bg-red-600 text-white hover:bg-indigo-50 focus:outline-none focus:bg-indigo-50 font-bold py-2 px-4 rounded-md">
                                                <a
