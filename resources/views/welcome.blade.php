                    ...
                    <div class="row align-items-center text-center justify-content-center">
                        <div class="col-sm-10 col-md-12 col-lg-10">
                            <div class="header-txt tab-center mobile-center">
                                ...
                                <p class="lead animated" data-animate="fadeInUp" data-delay="1.35">ProjectPilot aims to
            ...
            <div class="row justify-content-center text-center">
                ...
                <div class="col-sm-6 col-lg-3">
                    <div class="team-circle animated" data-animate="fadeInUp" data-delay=".6">
                        ...
                        <div class="team-info">
                            <h5 class="team-name">Gabriel Bernal</h5><span class="team-title">Community
                                Management</span>
                            <ul class="team-social">
                                <li><a href="#"><em class="fab fa-facebook-f"></em></a></li>
                                <li><a href="#"><em class="fab fa-linkedin-in"></em></a></li>
                        ...
                        <div id="team-profile-4" class="team-profile mfp-hide">
                            ...
                            <div class="container-fluid">
                                <div class="row no-mg">
                                    <div class="col-md-6">
                                        <div class="team-profile-photo"><img src="images/team-d-lg.jpg" alt="team" />
                                        </div>
                                    </div><!-- .col  -->
                                    <div class="col-md-6">
                                        <div class="team-profile-info">
            ...
            <div class="row justify-content-center text-center">
                <div class="col-lg-3 col-sm-6">
                    <div class="team-circle animated" data-animate="fadeInUp" data-delay=".8">
                        ...
                        <div class="team-info">
                            <h5 class="team-name">Dylan Finch</h5><span class="team-title">Board Advisor</span>
                            <ul class="team-social">
                                <li><a href="#"><em class="fab fa-facebook-f"></em></a></li>
                                <li><a href="#"><em class="fab fa-linkedin-in"></em></a></li>
                                <li><a href="#"><em class="fab fa-twitter"></em></a></li>
                        ...
                        <div id="team-profile-5" class="team-profile mfp-hide">
                            ...
                            <div class="container-fluid">
                                <div class="row no-mg">
                                    <div class="col-md-6">
                                        <div class="team-profile-photo"><img src="images/team-e-lg.jpg" alt="team" />
                                        </div>
                                    </div><!-- .col  -->
                                    <div class="col-md-6">
                                        <div class="team-profile-info">
                ...
                <div class="col-lg-3 col-sm-6">
                    <div class="team-circle animated" data-animate="fadeInUp" data-delay=".9">
                        ...
                        <div class="team-info">
                            <h5 class="team-name">Julian Paten</h5><span class="team-title">Board Advisor</span>
                            <ul class="team-social">
                                <li><a href="#"><em class="fab fa-facebook-f"></em></a></li>
                                <li><a href="#"><em class="fab fa-linkedin-in"></em></a></li>
                                <li><a href="#"><em class="fab fa-twitter"></em></a></li>
                        ...
                        <div id="team-profile-6" class="team-profile mfp-hide">
                            ...
                            <div class="container-fluid">
                                <div class="row no-mg">
                                    <div class="col-md-6">
                                        <div class="team-profile-photo"><img src="images/team-f-lg.jpg" alt="team" />
                                        </div>
                                    </div><!-- .col  -->
                                    <div class="col-md-6">
                                        <div class="team-profile-info">
                ...
                <div class="col-lg-3 col-sm-6">
                    <div class="team-circle animated" data-animate="fadeInUp" data-delay="1">
                        ...
                        <div class="team-info">
                            <h5 class="team-name">Jaxon Kilburn</h5><span class="team-title">Board Advisor</span>
                            <ul class="team-social">
                                <li><a href="#"><em class="fab fa-facebook-f"></em></a></li>
                                <li><a href="#"><em class="fab fa-linkedin-in"></em></a></li>
                                <li><a href="#"><em class="fab fa-twitter"></em></a></li>
                        ...
                        <div id="team-profile-7" class="team-profile mfp-hide">
                            ...
                            <div class="container-fluid">
                                <div class="row no-mg">
                                    <div class="col-md-6">
                                        <div class="team-profile-photo"><img src="images/team-g-lg.jpg" alt="team" />
                                        </div>
                                    </div><!-- .col  -->
                                    <div class="col-md-6">
                                        <div class="team-profile-info">
            ...
            <div class="row text-center">
                <div class="col-md-6 offset-md-3">
                    <div class="section-head">
                        <h3 class="section-title-md animated" data-animate="fadeInUp" data-delay=".1">
                            Our Partner</h3>
                    </div>
                </div>
            </div>
                ...
                <div class="col-lg-3">
                    <div class="widget-item">
                        ...
                        <div class="widget-subsctibe">
                            ...
                            <form id="subscribe-form" action="http://demo.themenio.com/ico/form/subscribe.php"
