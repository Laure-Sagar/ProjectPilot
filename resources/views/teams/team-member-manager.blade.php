<div>
    ...
    <div class="mt-10 sm:mt-0">
        <x-action-section>
            ...
            <x-slot name="description">
                {{ __('These people have been invited to your project and have been sent an invitation email. They may
                join
    ...
    <div class="mt-10 sm:mt-0">
        <x-action-section>
            ...
            <x-slot name="description">
                {{ __('All of the people that are part of this project.') }}
            </x-slot>
                ...
                <button type="button"
                    ...
                    <div class="{{ $currentRole !== $role->key ? 'opacity-50' : '' }}">
                        ...
                        <div class="flex items-center">
                            ...
                            <svg class="ml-2 h-5 w-5 text-green-400" xmlns="http://www.w3.org/2000/svg" fill="none"
